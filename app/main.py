...
from app.handlers.main_handlers import start_router, riding_now_router, get_live_location_router, who_is_near_router
...
async def main():
    ...
    dp.include_router(get_live_location_router)
